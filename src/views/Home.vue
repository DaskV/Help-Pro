 ...
 * @LastEditors: DaskV
 * @LastEditTime: 2019-09-09 15:58:30
 * @Description: 组件展示
 -->
<template>
  <div class="home">
    ...
    <a-divider> TinyEditor </a-divider>
    <a-card style="margin-bottom: 3rem">
      <tiny-editor :height="150" v-model="content" id="tinymce"></tiny-editor>
    </a-card>
...
import { DescriptionList, TagCloud, TinyEditor } from '@/components'
